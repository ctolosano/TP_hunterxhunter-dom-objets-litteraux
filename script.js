...
function CreateCard(title, number, description, image, rank) {
	...
	const divO1 = document.createElement("div");
	divO1.classList.add("o");
	divO1.textContent = number;

	const divAccompany = document.createElement("div");
	divAccompany.textContent = title;

	const divO2 = document.createElement("div");
	divO2.classList.add("o");
	divO2.textContent = rank;

	nav.appendChild(divO1);
	nav.appendChild(divAccompany);
	nav.appendChild(divO2);
	...
	const divOuip = document.createElement("div");
	divOuip.classList.add("ouip");

	const divD = document.createElement("div");
	divD.classList.add("d");

	const pOui = document.createElement("p");
	pOui.classList.add("oui");
	pOui.textContent = description;
	divD.appendChild(pOui);
	divOuip.appendChild(divD);

	main.appendChild(divImgWrapper);
	main.appendChild(divOuip);

	divNon.appendChild(nav);
	divNon.appendChild(main);
